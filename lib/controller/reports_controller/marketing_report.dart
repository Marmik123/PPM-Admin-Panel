...
class MReportController extends GetxController {
  RxBool isLoading = false.obs;
  RxList marketingReport = [].obs;

  Future<void> loadMarketingReport() async {
    isLoading.value = true;
    print("called load marketing report ");
    try {
      QueryBuilder<ParseObject> client =
          QueryBuilder<ParseObject>(ParseObject('MarketingMetadata'))
            ..orderByDescending('adsRegistered');
      ...
      if (result.success) {
        ...
        marketingReport(result.results);
      } else {
        isLoading.value = false;
